...
replace (
	github.com/flomesh-io/fsm/api/v1alpha1 => ./api/v1alpha1
	github.com/flomesh-io/fsm/cli => ./cli
	github.com/flomesh-io/fsm/controllers => ./controllers
	github.com/flomesh-io/fsm/pkg => ./pkg
	...
	k8s.io/utils/net => k8s.io/utils/net v0.21.8
)
