...
## Create Kubernetes Clusters and Install FSM
...
```shell
helm install --namespace flomesh --create-namespace --set fsm.version=0.2.12-alpha.3-dev --set fsm.logLevel=5 --set fsm.serviceLB.enabled=true fsm charts/fsm/
```
